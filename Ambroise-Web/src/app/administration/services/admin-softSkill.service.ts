...
import { ErrorService, genericRetryStrategy } from 'src/app/services/error.service';
import { Observable } from 'rxjs';
import { environment } from 'src/environments/environment';
import { catchError, timeout, retryWhen } from 'rxjs/operators';
...
export class AdminSoftSkillService {
    ...
    updateSoftSkillsOrder(softSkill: Skill[]) {
        ...
        return this.httpClient
            ...
            .pipe(timeout(5000), retryWhen(genericRetryStrategy()), catchError(error => this.errorService.handleError(error)));
    }
